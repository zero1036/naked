    ...
    return {
        ...
        link: function(scope, el, attrs) {
            el.bind("click", function() {
                ...
                //通知回滚
                scope.$emit("ngModelActionRollback" + attrs.ndModelCommit, isCommit, validationAction, goAction);
...
.directive('ndModelRollback', function() {
    return {
        ...
        link: function(scope, el, attrs, ngModel) {
            ...
            scope.$on("ngModelActionRollback" + attrs.ndModelRollback, function(event, isEnter, validationAction, goAction) {
                if (isEnter) {
